...
donationsRouter.get(
  "/donor/:requested_donor_id",
  DonorController.getDonationByDonorID
);

// Route for getting donations by campaign ID
donationsRouter.get(
  "/campaign/:requested_campaign_id",
  DonorController.getDonationByCampaignID
);

// Route for getting donations by both donor ID and campaign ID
donationsRouter.get(
  "/donor/:requested_donor_id/campaign/:requested_campaign_id",
  DonorController.getDonationByBothID
);
